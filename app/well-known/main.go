...
import (
	...
	"github.com/bhechinger/matrix-delegate/app/well-known/handlers"
)
...
func main() {
	log := log.New(os.Stdout, fmt.Sprintf("%s : ", namespace), log.LstdFlags|log.Lmicroseconds|log.Lshortfile)
...
func run(log *log.Logger) error {
	...
	api := http.Server{
		...
		Handler:      handlers.API(build, shutdown, log, cfg.Server, cfg.Port),
